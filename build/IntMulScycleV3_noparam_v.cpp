...
VIntMulScycleV3_noparam_t * create_model( const char *vcd_filename ) {
  ...
  m     = (VIntMulScycleV3_noparam_t *) malloc( sizeof(VIntMulScycleV3_noparam_t) );
  model = new VIntMulScycleV3_noparam();
...
void destroy_model( VIntMulScycleV3_noparam_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VIntMulScycleV3_noparam * model = (VIntMulScycleV3_noparam *) m->model;
...
void comb_eval( VIntMulScycleV3_noparam_t * m ) {
...
void seq_eval( VIntMulScycleV3_noparam_t * m ) {
...
#if VLINETRACE
void trace( VIntMulScycleV3_noparam_t * m, char* str ) {
