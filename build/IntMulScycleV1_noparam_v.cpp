...
extern "C" {
  ...
  // Exposed methods
  VIntMulScycleV1_noparam_t * create_model( const char * );
  void destroy_model( VIntMulScycleV1_noparam_t *);
  void comb_eval( VIntMulScycleV1_noparam_t * );
  void seq_eval( VIntMulScycleV1_noparam_t * );
  void assert_en( bool en );

  #if VLINETRACE
  void trace( VIntMulScycleV1_noparam_t *, char * );
  #endif
...
VIntMulScycleV1_noparam_t * create_model( const char *vcd_filename ) {
  ...
  m     = (VIntMulScycleV1_noparam_t *) malloc( sizeof(VIntMulScycleV1_noparam_t) );
  model = new VIntMulScycleV1_noparam();
...
void destroy_model( VIntMulScycleV1_noparam_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VIntMulScycleV1_noparam * model = (VIntMulScycleV1_noparam *) m->model;
...
void comb_eval( VIntMulScycleV1_noparam_t * m ) {
...
void seq_eval( VIntMulScycleV1_noparam_t * m ) {
...
#if VLINETRACE
void trace( VIntMulScycleV1_noparam_t * m, char* str ) {
