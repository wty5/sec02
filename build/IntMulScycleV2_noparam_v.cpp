...
#include "obj_dir_IntMulScycleV2_noparam/VIntMulScycleV2_noparam.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_IntMulScycleV2_noparam/VIntMulScycleV2_noparam__Syms.h"
#include "svdpi.h"
#endif
...
extern "C" {
  ...
  // Exposed methods
  VIntMulScycleV2_noparam_t * create_model( const char * );
  void destroy_model( VIntMulScycleV2_noparam_t *);
  void comb_eval( VIntMulScycleV2_noparam_t * );
  void seq_eval( VIntMulScycleV2_noparam_t * );
  void assert_en( bool en );

  #if VLINETRACE
  void trace( VIntMulScycleV2_noparam_t *, char * );
  #endif
...
VIntMulScycleV2_noparam_t * create_model( const char *vcd_filename ) {

  VIntMulScycleV2_noparam_t * m;
  VIntMulScycleV2_noparam   * model;

  Verilated::randReset( 0 );
  Verilated::randSeed( 0 );

  m     = (VIntMulScycleV2_noparam_t *) malloc( sizeof(VIntMulScycleV2_noparam_t) );
  model = new VIntMulScycleV2_noparam();
...
void destroy_model( VIntMulScycleV2_noparam_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VIntMulScycleV2_noparam * model = (VIntMulScycleV2_noparam *) m->model;
...
void comb_eval( VIntMulScycleV2_noparam_t * m ) {
...
void seq_eval( VIntMulScycleV2_noparam_t * m ) {
...
#if VLINETRACE
void trace( VIntMulScycleV2_noparam_t * m, char* str ) {
  ...
  svSetScope( &model->__VlSymsp->__Vscope_IntMulScycleV2_noparam__v );
